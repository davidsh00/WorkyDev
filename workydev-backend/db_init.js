...
const WorkProjectsDDL = DB.prepare('CREATE TABLE IF NOT EXISTS Workprojects (ID INTEGER PRIMARY KEY AUTOINCREMENT, WORK_ID TEXT NOT NULL, PROJECT_ID TEXT NOT NULL, FOREIGN KEY ("WORK_ID") REFERENCES "Work"("ID"), FOREIGN KEY ("PROJECT_ID") REFERENCES "Projects"("ID"))');
WorkProjectsDDL.run();