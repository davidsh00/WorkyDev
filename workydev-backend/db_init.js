...
const WorkProjectsDDL = DB.prepare('CREATE TABLE IF NOT EXISTS Workprojects (ID INTEGER PRIMARY KEY AUTOINCREMENT, WORK_ID INTEGER NOT NULL, PROJECT_ID INTEGER NOT NULL, FOREIGN KEY ("WORK_ID") REFERENCES "Works"("ID"), FOREIGN KEY ("PROJECT_ID") REFERENCES "Projects"("ID"))');
WorkProjectsDDL.run();